...
def home():
	...
	hsc ={"school":"St. Joseph High School and Junior College","board":"Maharashtra State Board","percentage":"91.8"}

	diploma ={"school":"St. Joseph High School and Junior College","university":"Mumbai Univeristy","percentage":"91.8"}
	#diploma ={}

	skills ={ "Technical Domain": [["Mobile App Development","Intermediate"],["Internet of Things(IoT)", "Advanced"],
	            ["Internet of Things(IoT)", "Advanced"],["Internet of Things(IoT)", "Advanced"]],
			"Soft Skills": [["Decision Making","Intermediate"],["Time Management", "Basic"],
			["Time Management", "Basic"],["Time Management", "Basic"]]}
	...
	goals = [{"description":"Become world leader","type":"Long Term"},{"description":"Become payer xux","type":"Short Term"},
	    {"description":"Become p s   s dsfdsfdsfdsf dsfds","type":"Short Term"}, {"description":"Become sdfsdfdf d d dssdsg x","type":"Long Term"}]
	...
	return render_template('ep3/index.html', member=member, personal=personal, grad=grad,links=links,
							...
							activExtra=activExtra,goals=goals, skills=skills, certi=certi,collegeLinks=collegeLinks)
